...
- Annihilator of an $\mathcal{O}_{X}$-Module — (0.5.3.7)
...
- Canonical sections of $\mathcal{O}^{n}_{X}$ — (I, 5.5.5)
...
- Coherent $\mathcal{O}_{X}$-Module — (0.5.3.1)
- Coherent $\mathcal{O}_{X}$-Algebra — (0.5.3.6)
...
- Completion of an $\mathcal{O}_{X}$-Module / morphism along a closed subset — (I, 10.8.4)
...
- Direct image of an $\mathcal{O}_{X}$-Module — (0.4.2.1)
...
- Double homomorphism ($\phi$-homomorphism of modules) — (0.1.0.2)
- Dual of an $\mathcal{O}_{X}$-Module — (0.4.1.4)
...
- Exterior power of an $\mathcal{O}_{X}$-Module — (0.4.1.4)
...
- Finite-type $\mathcal{O}_{X}$-Module — (0.5.2.1)
...
- Graded $\mathcal{O}_{X}$-Module — (0.4.1.3)
...
- Inverse of an invertible $\mathcal{O}_{X}$-Module — (0.5.4.3)
- Invertible $\mathcal{O}_{X}$-Module — (0.5.4.1)
...
- Locally free $\mathcal{O}_{X}$-Module — (0.5.4.1)
...
- $A$-morphism, $\mathfrak{S}$-morphism of formal preschemes — (I, 10.4.7)
- $\phi$-morphism of presheaves — (0.3.5.1)
- $\Psi$-morphism of an $\mathcal{O}_{X}$-Module into an $\mathcal{O}_{Y}$-Module — (0.4.4.1)

## N

- Nilradical of a ring — (0.1.1.1)
- Nilradical of an $\mathcal{O}_{X}$-Algebra — (I, 5.1.1)
...
- $f$-flat ($\mathcal{O}_{X}$-Module) — (0.6.7.1)
...
- Preadic ring, $\mathfrak{J}$-preadic — (0.7.1.9)
...
- Prescheme, deduced by reduction mod $\mathfrak{J}$ — (I, 3.7.1)
...
- Presentation, finite ($\mathcal{O}_{X}$-Module) — (0.5.2.5)
- Principle of Noetherian induction — (0.2.2.2)
- Product of $S$-preschemes — (I, 3.2.1)
- Product of $\mathfrak{S}$-formal preschemes — (I, 10.7.1)
...
- Power, exterior $p$-th of an $\mathcal{O}_{X}$-Module — (0.4.1.4)

## Q

- Quasi-coherent $\mathcal{O}_{X}$-Module — (0.5.1.3)
- Quasi-coherent $\mathcal{O}_{X}$-Algebra — (0.5.1.3)

## R

- Radical of an ideal — (0.1.1.1)
- Radical of a ring — (0.1.1.2)
- Rank of a locally free $\mathcal{O}_{X}$-Module — (0.5.4.1)
- Rank of a torsion-free $\mathcal{O}_{X}$-Module — (I, 7.4.2)
...
- Rational map induced on $\operatorname{Spec}(...)$ — (I, 7.2.8)
...
- Sub-$\mathcal{O}_{X}$-Algebra generated by a sub-Module — (0.4.1.3)
...
- Topology, $\mathfrak{J}$-adic — (0.7.1.9), (0.7.2.3)
- Topology, $\mathfrak{J}$-preadic — (0.7.1.9)
- Topology, spectral — (I, 1.1.2)
- Topology, Zariski — (I, 1.1.2) (footnote)
- Trivial invertible $\mathcal{O}_{X}$-Module — (I, 2.4.8)
- Type, finite ($\mathcal{O}_{X}$-Module of) — (0.5.2.1)

## U

- Unit section of $\mathcal{O}_{X}$ — (0.4.1.1)
