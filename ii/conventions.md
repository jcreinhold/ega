...
- Structure sheaves and standard sheaves: `𝒪_X`, `𝒪_Y`, `𝒪_S`, `𝒪_X(1)`, `𝒪(n)`, `ℳ`, `ℱ`, `𝒢`, `𝒮`, `𝒜`, `ℬ`, `ℐ`,
    `ℐₙ`, `ℛ`, `𝒥`, `𝒩`.
...
- Functors: write `Hom`, `Spec`, `Proj`, `Γ`, `Sym`, `det`, `Pic`, `End`, `Aut` in upright Roman.

- Specs: `Spec(A)`, `Proj(S)`, `Spec(𝒮)` for the relative Spec, `Proj(𝒮)` similarly.

- Greek letters as plain Unicode in backticks: `φ`, `ψ`, `ρ`, `σ`, `τ`, `θ`, `ω`, `Δ`, `Γ`, `Ω`, `Σ`.
